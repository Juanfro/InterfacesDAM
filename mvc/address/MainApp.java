...
public class MainApp extends Application {
	...
	/**
	 * Datos como una ObservableList de Person
	 */
	...
	public MainApp() {
		// Añadir datos
		personData.add(new Person("Juan Antonio", "Rodríguez"));
		personData.add(new Person("Perico", "el de los Palotes"));
		personData.add(new Person("Rita", "La Cantaora"));
		personData.add(new Person("Paco", "Martinez Soria"));
		personData.add(new Person("Wernher", "von Braun"));
		personData.add(new Person("Son", "Goku"));
		personData.add(new Person("Leto", "Atreides"));
		personData.add(new Person("Vladimir ", "Harkonnen"));
		personData.add(new Person("Geralt", "of Rivia"));
	}

	/**
	 * Devuelve los datos como una ObservableList de Person
	 * 
	 * @return
	 */
	...
	/**
	 * Muestra la scene que contienen root layout
	 */
	...
	/**
	 * Abre un dialogo para editar datos de la persona especificada. <br>
	 * Si el usuario hace click en OK, los cambio se guardan en el objeto persona y
	 * se devuelve TRUE
	 * 
	 * @param person
	 * @return
	...
	public void savePersonDataToFile(File file) {
		try {
			...
			alert.setTitle("ERROR");
			alert.setHeaderText("ERROR");
			alert.setContentText("Could not save data data to file:\n" + file.getPath());
			alert.showAndWait();
